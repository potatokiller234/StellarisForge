...
namespace AnotherFileBrowser.Windows
{
    public class FileBrowser
    {
        ...
        /// <param name="resultingFilePath">User picked path (Callback)</param>
        public void OpenFileBrowser(BrowserProperties browserProperties,string truePath, Action<string> resultingFilePath)
        {
